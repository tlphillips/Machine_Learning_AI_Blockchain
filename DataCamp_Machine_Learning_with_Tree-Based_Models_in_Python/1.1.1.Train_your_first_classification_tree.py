'''In this exercise you'll work with the Wisconsin Breast Cancer Dataset- https://www.kaggle.com/uciml/breast-cancer-wisconsin-data from the UCI machine learning repository. 
