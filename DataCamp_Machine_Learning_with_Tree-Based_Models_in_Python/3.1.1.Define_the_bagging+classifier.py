'''In the following exercises you'll work with the Indian Liver Patient dataset-https://www.kaggle.com/uciml/indian-liver-patient-records from the UCI machine learning repository. 
